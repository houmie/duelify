...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ring.topic'
        db.alter_column(u'duelify_app_ring', 'topic', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Ring.topic'
        db.alter_column(u'duelify_app_ring', 'topic', self.gf('django.db.models.fields.CharField')(max_length=30))
